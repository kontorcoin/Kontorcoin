...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(137438691328);	// 7th perfect number
...
const char     CRYPTONOTE_NAME[]                             = "kontorcoin";
...
const int      P2P_DEFAULT_PORT                              =  9093;
const int      RPC_DEFAULT_PORT                              =  9092;
...
const char     P2P_STAT_TRUSTED_PUB_KEY[] = "B29507CA55455F37A3B783FF2C5123B8B6A34A0C5CAAE056800C6254161480C1";
